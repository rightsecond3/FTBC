...
/////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
function next_page(){//페이지 하단 다음버튼
    $("#tab2").removeClass("active");
    $("#tab3").attr('class','active');
 }
function pre_page(){//페이지 하단 이전 버튼
    $("#tab2").removeClass("active");
...
function itemAddConfirm(){
		if($("#itemListHeaderTbody tr").length<=14){ //itemListHeaderTbody의 tr 개수가 14까지 즉 15가 되면 더 이상 저장할 수 없다.
			if($("#itemListHeaderTbody").has(document.getElementById('itemListEditShow0')).html()==undefined){
				...
				if($("input:radio[id='option1']:checked").length==1){
					...
					document.getElementById("itemListOptionInput0").value =$("#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput0").value =$("#jugwanSicInput").val();
				}
			}else if($("#itemListHeaderTbody").has(document.getElementById('itemListEditShow1')).html()==undefined){
				var a = $("#defaultHideList").html();
				...
				if($("input:radio[id='option1']:checked").length==1){
					...
					var change = $("#multipleChoiceInput").val();
					select = select.concat(change);
					document.getElementById("itemListOptionInput1").value =select.replace(/\n/gi,",");
					document.getElementById("itemListOptionOutput1").value =select.replace(/\n/gi,",");
				}else if($("input:radio[id='option3']:checked").length==1){
					document.getElementById("itemListOptionInput1").value =$("#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput1").value =$("#jugwanSicInput").val();
				}
			}else if($("#itemListHeaderTbody").has(document.getElementById('itemListEditShow2')).html()==undefined){
				var a = $("#defaultHideList").html();
				...
				if($("input:radio[id='option1']:checked").length==1){
					...
					var change = $("#multipleChoiceInput").val();
					select = select.concat(change);
					document.getElementById("itemListOptionInput2").value =select.replace(/\n/gi,",");
					document.getElementById("itemListOptionOutput2").value =select.replace(/\n/gi,",");
				}else if($("input:radio[id='option3']:checked").length==1){
					document.getElementById("itemListOptionInput2").value =$("#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput2").value =$("#jugwanSicInput").val();
				}
			}else if($("#itemListHeaderTbody").has(document.getElementById('itemListEditShow3')).html()==undefined){
				var a = $("#defaultHideList").html();
				...
				if($("input:radio[id='option1']:checked").length==1){
					...
					var change = $("#multipleChoiceInput").val();
					select = select.concat(change);
					document.getElementById("itemListOptionInput3").value =select.replace(/\n/gi,",");
					document.getElementById("itemListOptionOutput3").value =select.replace(/\n/gi,",");
				}else if($("input:radio[id='option3']:checked").length==1){
					document.getElementById("itemListOptionInput3").value =$("#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput3").value =$("#jugwanSicInput").val();
				}
			}else if($("#itemListHeaderTbody").has(document.getElementById('itemListEditShow4')).html()==undefined){
				var a = $("#defaultHideList").html();
				...
				if($("input:radio[id='option1']:checked").length==1){
					...
					var change = $("#multipleChoiceInput").val();
					select = select.concat(change);
					document.getElementById("itemListOptionInput4").value =select.replace(/\n/gi,",");
					document.getElementById("itemListOptionOutput4").value =select.replace(/\n/gi,",");
				}else if($("input:radio[id='option3']:checked").length==1){
					document.getElementById("itemListOptionInput4").value =$("#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput4").value =$("#jugwanSicInput").val();
...
function projectEndDateOutputShow(){
	document.getElementById("projectEndDateOutput").value=$("#datepicker").val();
	paymentEndDate();
...
<form id="Project_Composition" name="Project_Composition" onSubmit="return false" class="create_form">
	...
	<div id="goalMoney" onclick="goalMoneyShow()">
		...
		<div class="row">
			<div id="goalMoneyInputHide" class="col-xs-10">
				<div><i class="glyphicon glyphicon-hand-right"></i><label>&nbsp; 목표 금액을 입력해주세요</label></div>
			</div>
			<div id="goalMoneyInputShow" class="col-xs-10">
				<div><input type="text" class="chundanwigubun" name="goalMoneyOutput" id="goalMoneyOutput"><label>&nbsp;원</label></div>
			</div>
			...
			<div id="goalMoneyEditShow" class="col-xs-2">
				<div><i class="glyphicon glyphicon-edit"></i><label>&nbsp; 수정하기</label></div>
			</div>
		</div>
	</div>
	<!-- ============================목표금액 디폴트 화면 끝=========================== -->
	...
	<div id="goalMoneyShow" >
		...
		<div id="goalMoneyInputMoney"class="row">
			<input type="text" class="chundanwigubun" name="goalMoneyInput" id="goalMoneyInput" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');">
			<label>원</label>
		</div>
		<div id="commissionCalculation">
			...
			<div class="row">
				<div class="col-xs-10">
					<b>예시)</b> 100,000,000원의 금액을 모으는데 성공하실 경우 <b>대략 91,200,000 원 정도</b>를 받게 됩니다. 총 모금액에서 대략적으로
					아래와 같은 금액이 공제됩니다.
				</div>
			</div> 
			<div class="row">
		...
		<div id="goalPriceButton">
			<button id="goalPriceCancelButton" onclick="goalMoneyShowHide()" type="button" class="btn btn-default btn-lg">
				<i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;취소하기
			</button>
			<button id="goalPriceConfirmButton" onclick="goalMoneyRegistration()" type="button" class="btn btn-default btn-lg">
	...
	<div id="projectEndDateShow" >
		...
		<div id="datepickerRow" class="row">
			<div class="cols-xs-8">
					  <input type="text" class="chundanwigubun" id="datepicker" name="datepicker" onclick="paymentEndDate()">
					  <script>
		...
		<div id="projectEndDateButton">
			<button id="projectEndDateCancelButton" onclick="projectEndDateShowHide()" type="button" class="btn btn-default btn-lg">
				<i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;취소하기
			</button>
			<button id="projectEndDateConfirmButton" onclick="projectEndDateOutputShow()" type="button" class="btn btn-default btn-lg">
				<i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;저장하기
			</button>
		</div>
	</div>
	...
	<div id="moneyEstimatedDate">
		...
		<div class="row">
			<div class="col-xs-10">
				<div><label>&nbsp; 마감일을 입력하시면 예상 정산일을 안내드립니다.</label></div>
			</div>
		</div>
	</div>
	<!-- ===================================예상정산일 디폴트 폼 끝=================================== -->
	...
	<table id="giftConfigurationTable">
		...
		<div id="giftConfigShow" >
			...
			<div class="row">
				<div class="col-xs-12">
					...
					배송이 필요한 선물의 경우 <b>배송비 포함</b>된 금액으로 작성해주세요.
				</div>
			</div>
			<div class="row">
				<div class="col-xs-10">
					<input id="minDonationMoneyInput" name="minDonationMoney" type="text" class="chundanwigubun" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');">&nbsp;원 이상 밀어주시는 분께 드리는 선물입니다.
				</div>
			</div>
			<hr>
			<div class="row">
			...
			<div class="row">
				<div class="col-xs-12">
					아이템은 <b>선물에 포함되는 구성 품목</b>을 말합니다. 이 금액대의 선물을 선택한 후원자에게 어떤
					아이템들을 얼마나 전달하실건가요?
				</div>
			</div>
		...
		<!-- ===============이 로우가 계속 생성되어야함. 끝 -->
			...
			<div id="itemAdmin" class="row">
				<button type="button" data-toggle="modal" data-target="#itemAdminModal"><i class="glyphicon glyphicon-th-list"></i>&nbsp;아이템 만들기</button>
			</div>	
			<!-- ==============선물 아이템 관리하기 모달 쇼폼 시작====================== -->
			<div class="modal" id="itemAdminModal" role="dialog" >
				<div class="modal-dialog">
					<div class="modal-content" style="right:20%;width:850px;height:auto;">
						...
						<div class="modal-body">
							...
							<div id="itemAdd" onClick="itemAddShow()">
								<div class="row">
									<div id="itemAddRow1"class="col-xs-12" >
										<h4><label>아이템 추가하기</label></h4>
									</div>
								</div>
								<div class="row">
									<div id="itemAddRow2" class="col-xs-12">
										<div><label>선물 구성에 추가할 아이템을 만듭니다.</label></div>
									</div>
								</div>
								<div class="row">
									<div id="itemAddRowInputButton">
										<button type="BUTTON" onclick="itemAddShow()"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;<b>추가하기</b></button>
									</div>
								</div>
							</div>
							<!-- ========================================== -->
							<div id="itemAddShow">
								...
								<div class="row">
									...
									<div><label><input type="radio" id="option1" name="group">&nbsp; 옵션이 필요없는 아이템입니다.</label></div>
									<div id="multipleChoiceOption">
										<div><label><input type="radio" id="option2" name="group">&nbsp; 객관식 옵션이 필요한 아이템입니다.(사이즈,색상 등)</label></div>
										<div><textarea name="multipleChoiceInput" id="multipleChoiceInput"  
										placeholder="옵션 항목을 입력해주세요.
옵션 항목은 줄바꿈으로 구분됩니다.
예시)블랙-230mm
화이트-240mm" 							rows="4"></textarea></div>
										<div></div>
									</div>
									<div id="jugwansicOption">
										<div><label><input type="radio" id="option3" name="group" >&nbsp; 주관식 옵션이 필요한 아이템입니다.(각인,메시지 등)</label></div>
										<div><textarea name="jugwanSicInput"id="jugwanSicInput" 
										placeholder="후원자에게 안내할 메시지를 작성해 주세요.
예시) 사이즈, 메시지 순으로 작성해 주세요." 		rows="2"></textarea></div>
									</div>
									<div id="itemAddButton">
										<button id="itemAddCancelButton" onclick="itemConfigShowHide()" type="button" class="btn btn-default btn-lg">
											<i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;취소하기
										</button>
										<button id="itemAddConfirmButton" onclick="itemAddConfirm()" type="button" class="btn btn-default btn-lg">
											<i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;저장하기
										</button>
									</div>
								</div>
						...
						<div class="modal-footer">
							<button id="modalFooterCloseButton" type="button" class="btn btn-default" data-dismiss="modal">닫기</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-10">
					<textarea  id="giftTextAreaInput" placeholder="예) 배송비 포함, 얼리버드,<선물 세트 A>등"></textarea>
				</div>
			</div>
			<hr>
			<div class="row">
			...
			<div class="row">
				<div class="col-xs-12">
					이 선물을 선택한 후원자들에게 선물을 배송 또는 공개하기로 약속하는 날입니다.<b>결제 종료일 이후의 날짜</b>인지 확인해서 정해주세요.
				</div>
			</div>
			<div class="row">
				<div class="col-xs-10">
			...
			<div id="giftControl">
				...
				<div id="limitedAndDeliveryCheck" class="row">
						<div class="col-xs-5">
							<label><input id="limitedCheck" name="limitedCheck" type="checkbox" onClick="checkLimted()">선물을 
			...
			<div id="giftConfigButton">
				<button id="giftConfigCancelButton" onclick="giftConfigShowHide()" type="button" class="btn btn-default btn-lg">
					<i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;취소하기
				</button>
				<button id="giftConfigConfirmButton" onclick="giftAdd()" type="button" class="btn btn-default btn-lg">
					<i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;저장하기
				</button>
			</div>
		</div>
	...
	<!-- ===================================환불 및 교환 정책 디폴트 폼 시작=============================== -->
		...
		<div id="refundAndExchanges" onclick="refundAndExchangesShow()">
			...
			<div id="refundAndExchangeOutputDefault" class="row">
				<div class="col-xs-10">
						<div><i class="glyphicon glyphicon-hand-right"></i><label>&nbsp;환불 및 교환 정책을 입력해주세요</label></div>
				</div>
				<div class="col-xs-2">
					<div><i class="glyphicon glyphicon-edit"></i><label>&nbsp; 입력하기</label></div>
				</div>
			...
			<div id="refundAndExchangeOutput" class="row">
				<div class="col-xs-10">
					<textarea id="refundAndExchangeSpan" name="refundAndExchangeSpan" style="white-space:pre;"></textarea>
				</div>
				<div class="col-xs-2">
					<div><i class="glyphicon glyphicon-edit"></i><label style="padding-left:0px;">&nbsp; 수정하기</label></div>
				</div>
			</div>
		</div>
	<!-- ===================================환불 및 교환 정책 디폴트 끝================================== -->
	<!-- ===================================환불 및 교환 정책 쇼폼 시작================================== -->
		<div id="refundAndExchangesShow">
			...
			<div class="row">
				<div class="col-xs-12">
					펀딩 마감 후의 환불 및 교환 요청은 창작자가 약속하는 정책에 따릅니다.
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12">
...
- 전달된 파일은 타인에게 양도가 [  가능  /  불가능  ]합니다.]</textarea>
			...
			<div id="refundAndExchangeButton">
				<button id="refundAndExchangeCancelButton" onclick="refundAndExchangesShowHide()" type="button" class="btn btn-default btn-lg">
					<i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;취소하기
				</button>
				<button id="refundAndExchangeConfirmButton" onclick="refundAndExchangesAdd()" type="button" class="btn btn-default btn-lg">
					<i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;저장하기
				</button>
			</div>
		</div>
			...
			<div class="row">
				<div id="bottomPreNextButton"class="col-xs-12">
					<a class="tab_menu" data-toggle="tab" href="#menu3">
						<button onClick="next_page()" class="button button_next">다음<i class="glyphicon glyphicon-chevron-right"></i></button>
					</a>
					<a class="tab_menu" data-toggle="tab" href="#menu1">
						<button onClick="pre_page()" class="button button_pre"><i class="glyphicon glyphicon-chevron-left"></i>이전</button>
					</a>
				</div>
			</div>
		<!-- ======================하단 이전 다음 버튼 끝========================= -->	
...
<tr id="itemListEditShow0"><td colspan="3"><div><div id="itemListAddEditShow0"><div class="row"><label>아이템 이름</label></div><div><input id="newMakeItemName1" name="newMakeItemName1" type="text" class="ilbanText" placeholder="새로 만들 아이템의 이름을 입력하세요." ></div><div class="row"><label><strong>옵션 조건</strong></label>
															...
															<div id="multipleChoiceOption0">
																...
																<div><textarea name="tbodyMultipleChoiceInput0" id="tbodyMultipleChoiceInput0" placeholder="옵션 항목을 입력해주세요.
옵션 항목은 줄바꿈으로 구분됩니다.
예시)블랙-230mm
화이트-240mm" 													rows="4" onChange="tbodyMultipleChoiceInput()"></textarea>
																</div>
															</div>
														<div id="jugwansicOption0">
															<div><label><input type="radio" id="tbodyoption03" name="group">&nbsp; 주관식 옵션이 필요한 아이템입니다.(각인,메시지 등)</label></div>
															<div><textarea name="tbodyJugwanSicInput0"id="tbodyJugwanSicInput0" 
																placeholder="후원자에게 안내할 메시지를 작성해 주세요.
예시) 사이즈, 메시지 순으로 작성해 주세요." 								rows="2" onChange="tbodyJugwanSicInput()" ></textarea></div>
														</div>
														<div id="itemAddButton"> 
											...
											<td colspan="3">
												<div>
													<div id="itemListAddDeleteShow">
														<div class="row">
															<div><i class="glyphicon glyphicon-trash"></i><b>아이템 삭제하기</b></div>
														</div>
														<div id="deleteCheck" class="row">
															<div>아이템을 삭제하면 현재 구성 중인 선물 뿐만 아니라 다른 선물도 영향을 받습니다. 그래도 삭제 하시겠습니까?</div>
														</div>
														<div id="deleteButton"> 
															<button id="deleteCancelButton" onclick="itemListAddDeleteShowHide()" type="button" class="btn btn-default btn-lg">
																<i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;취소하기
															</button>
															<button id="deleteConfirmButton" onclick="itemListAddDelete0()" type="button" class="btn btn-default btn-lg">
...
<tr id="itemListEditShow1"><td colspan="3"><div><div id="itemListAddEditShow1"><div class="row"><label>아이템 이름</label></div><div><input id="newMakeItemName2" name="newMakeItemName2" type="text" class="ilbanText"  placeholder="새로 만들 아이템의 이름을 입력하세요." ></div><div class="row"><label><strong>옵션 조건</strong></label>
															...
															<div id="multipleChoiceOption1">
																...
																<div><textarea name="tbodyMultipleChoiceInput1" id="tbodyMultipleChoiceInput1" placeholder="옵션 항목을 입력해주세요.
옵션 항목은 줄바꿈으로 구분됩니다.
예시)블랙-230mm
화이트-240mm" 													rows="4" onChange="tbodyMultipleChoiceInput()"></textarea>
																</div>
														...
														<div id="jugwansicOption1">
															<div><label><input type="radio" id="tbodyoption13" name="group">&nbsp; 주관식 옵션이 필요한 아이템입니다.(각인,메시지 등)</label></div>
															<div><textarea name="tbodyJugwanSicInput1"id="tbodyJugwanSicInput1" 
																placeholder="후원자에게 안내할 메시지를 작성해 주세요.
예시) 사이즈, 메시지 순으로 작성해 주세요." 								rows="2" onChange="tbodyJugwanSicInput()" ></textarea></div>
														</div>
														<div id="itemAddButton"> 
												...
												<div>
													<div id="itemListAddDeleteShow">
														...
														<div id="deleteButton"> 
															...
															<button id="deleteConfirmButton" onclick="itemListAddDelete1()" type="button" class="btn btn-default btn-lg">
																<i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;삭제하기
															</button>
														</div>
													</div>
...
화이트-240mm" 													rows="4" onChange="tbodyMultipleChoiceInput()"></textarea>
														...
														<div id="jugwansicOption2">
															<div><label><input type="radio" id="tbodyoption23" name="group">&nbsp; 주관식 옵션이 필요한 아이템입니다.(각인,메시지 등)</label></div>
															<div><textarea name="tbodyJugwanSicInput2"id="tbodyJugwanSicInput2" 
																placeholder="후원자에게 안내할 메시지를 작성해 주세요.
예시) 사이즈, 메시지 순으로 작성해 주세요." 								rows="2" onChange="tbodyJugwanSicInput()" ></textarea></div>
														</div>
														<div id="itemAddButton"> 
												...
												<div>
													<div id="itemListAddDeleteShow">
														...
														<div id="deleteButton"> 
															...
															<button id="deleteConfirmButton" onclick="itemListAddDelete2()" type="button" class="btn btn-default btn-lg">
																<i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;삭제하기
															</button>
														</div>
													</div>
...
화이트-240mm" 													rows="4" onChange="tbodyMultipleChoiceInput()"></textarea>
														...
														<div id="jugwansicOption3">
															<div><label><input type="radio" id="tbodyoption33" name="group">&nbsp; 주관식 옵션이 필요한 아이템입니다.(각인,메시지 등)</label></div>
															<div><textarea name="tbodyJugwanSicInput3"id="tbodyJugwanSicInput3" 
																placeholder="후원자에게 안내할 메시지를 작성해 주세요.
예시) 사이즈, 메시지 순으로 작성해 주세요." 								rows="2" onChange="tbodyJugwanSicInput()" ></textarea></div>
														</div>
														<div id="itemAddButton"> 
												...
												<div>
													<div id="itemListAddDeleteShow">
														...
														<div id="deleteButton"> 
															...
															<button id="deleteConfirmButton" onclick="itemListAddDelete3()" type="button" class="btn btn-default btn-lg">
																<i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;삭제하기
															</button>
														</div>
													</div>
...
화이트-240mm" 													rows="4" onChange="tbodyMultipleChoiceInput()"></textarea>
														...
														<div id="jugwansicOption4">
															<div><label><input type="radio" id="tbodyoption43" name="group">&nbsp; 주관식 옵션이 필요한 아이템입니다.(각인,메시지 등)</label></div>
															<div><textarea name="tbodyJugwanSicInput4"id="tbodyJugwanSicInput4" 
																placeholder="후원자에게 안내할 메시지를 작성해 주세요.
예시) 사이즈, 메시지 순으로 작성해 주세요." 								rows="2" onChange="tbodyJugwanSicInput()" ></textarea></div>
														</div>
														<div id="itemAddButton"> 
												...
												<div>
													<div id="itemListAddDeleteShow">
														...
														<div id="deleteButton"> 
															...
															<button id="deleteConfirmButton" onclick="itemListAddDelete4()" type="button" class="btn btn-default btn-lg">
																<i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;삭제하기
															</button>
														</div>
													</div>
