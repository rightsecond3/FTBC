...
<script>
		...
		if ($("#itemListHeaderTbody tr").length <= 14) { //itemListHeaderTbody의 tr 개수가 14까지 즉 15가 되면 더 이상 저장할 수 없다.
			if ($("#itemListHeaderTbody").has(
				...
				if ($("input:radio[id='option1']:checked").length == 1) {
					...
					document.getElementById("itemListOptionInput0").value = $(
							"#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput0").value = $(
							"#jugwanSicInput").val();
				}
				...
				if ($("input:radio[id='option1']:checked").length == 1) {
					...
					document.getElementById("itemListOptionInput1").value = $(
							"#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput1").value = $(
							"#jugwanSicInput").val();
				}
			} else if ($("#itemListHeaderTbody").has(
				...
				if ($("input:radio[id='option1']:checked").length == 1) {
					...
					document.getElementById("itemListOptionInput2").value = $(
							"#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput2").value = $(
							"#jugwanSicInput").val();
				}
			} else if ($("#itemListHeaderTbody").has(
				...
				if ($("input:radio[id='option1']:checked").length == 1) {
					...
					document.getElementById("itemListOptionInput3").value = $(
							"#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput3").value = $(
							"#jugwanSicInput").val();
				}
			} else if ($("#itemListHeaderTbody").has(
				...
				if ($("input:radio[id='option1']:checked").length == 1) {
					...
					document.getElementById("itemListOptionInput4").value = $(
							"#jugwanSicInput").val();
					document.getElementById("itemListOptionOutput4").value = $(
							"#jugwanSicInput").val();
	...
	function goalMoneyRegistration() {
		document.getElementById("goalMoneyOutput").value = $("#goalMoneyInput")
				.val();
	...
	function projectEndDateOutputShow() {
		document.getElementById("projectEndDateOutput").value = $("#datepicker")
				.val();
		paymentEndDate();
	...
	function giftAdd() {
		...
		giftInfo = giftInfo.replace(/remainQuantity/gi, "remainQuantity"
				+ nonce);
		...
		if ($("#YesNoGroup0").length == 1 || $("#YesNoGroup1").length == 1
			...
			if ($("#YesNoGroup0").length == 1) {
				if (YesNoGroup0.checked == true) {
					...
					a = a
							.replace(/GiftUlListName/gi, "GiftUlListName0"
									+ nonce);
					a = a.replace(/GiftUlListQuantity/gi, "GiftUlListQuantity0"
							+ nonce);
					$('#' + giftUlList).append(a);
					document.getElementById("GiftUlListName0" + nonce).value = $(
							"#itemListNameOutput0").val();
					document.getElementById("GiftUlListQuantity0" + nonce).value = $(
							"#itemQuantityOption0").val();
				}
			}
			if ($("#YesNoGroup1").length == 1) {
				if (YesNoGroup1.checked == true) {
					var a = $("#defaultGiftUlList").html();
					a = a
							.replace(/GiftUlListName/gi, "GiftUlListName1"
									+ nonce);
					a = a.replace(/GiftUlListQuantity/gi, "GiftUlListQuantity1"
							+ nonce);
					$('#' + giftUlList).append(a);
					document.getElementById("GiftUlListName1" + nonce).value = $(
							"#itemListNameOutput1").val();
					document.getElementById("GiftUlListQuantity1" + nonce).value = $(
							"#itemQuantityOption1").val();
				}
			}
			if ($("#YesNoGroup2").length == 1) {
				if (YesNoGroup2.checked == true) {
					var a = $("#defaultGiftUlList").html();
					a = a
							.replace(/GiftUlListName/gi, "GiftUlListName2"
									+ nonce);
					a = a.replace(/GiftUlListQuantity/gi, "GiftUlListQuantity2"
							+ nonce);
					$('#' + giftUlList).append(a);
					document.getElementById("GiftUlListName2" + nonce).value = $(
							"#itemListNameOutput2").val();
					document.getElementById("GiftUlListQuantity2" + nonce).value = $(
							"#itemQuantityOption2").val();
				}
			}
			if ($("#YesNoGroup3").length == 1) {
				if (YesNoGroup3.checked == true) {
					var a = $("#defaultGiftUlList").html();
					a = a
							.replace(/GiftUlListName/gi, "GiftUlListName3"
									+ nonce);
					a = a.replace(/GiftUlListQuantity/gi, "GiftUlListQuantity3"
							+ nonce);
					$('#' + giftUlList).append(a);
					document.getElementById("GiftUlListName3" + nonce).value = $(
							"#itemListNameOutput3").val();
					document.getElementById("GiftUlListQuantity3" + nonce).value = $(
							"#itemQuantityOption3").val();
				}
			}
			if ($("#YesNoGroup4").length == 1) {
				if (YesNoGroup4.checked == true) {
					var a = $("#defaultGiftUlList").html();
					a = a
							.replace(/GiftUlListName/gi, "GiftUlListName4"
									+ nonce);
					a = a.replace(/GiftUlListQuantity/gi, "GiftUlListQuantity4"
							+ nonce);
					$('#' + giftUlList).append(a);
					document.getElementById("GiftUlListName4" + nonce).value = $(
							"#itemListNameOutput4").val();
					document.getElementById("GiftUlListQuantity4" + nonce).value = $(
							"#itemQuantityOption4").val();
				}
			}
		}
		$("#giftConfiguration").hide();
	...
	function change() {
		...
		if (summary_all_form.short_title.value == ""
				|| summary_all_form.long_title.value == ""
				|| summary_all_form.pjo_summary_edit_text.value == ""
				|| summary_all_form.pjo_page_text.value == ""
				|| summary_all_form.pjo_tag_text.value == ""
				|| summary_all_form.pjo_name_text.value == ""
				|| summary_all_form.pjo_introduction_edit_textarea.value == ""
				|| summary_all_form.pjo_active_area_text.value == "") {
			$("#check_tab").html(
							...
							<div id="datepickerRow" class="row">
								<div class="cols-xs-8">
									<input type="text" class="chundanwigubun" id="datepicker"
										name="datepicker" onclick="paymentEndDate()">
									<script>
										$("#datepicker").value = $(
	...
	<div class="row">
		<div id="bottomPreNextButton" class="col-xs-12">
			<a class="tab_menu" data-toggle="tab" href="#menu3">
				<button onClick="next_page()" class="button button_next">
					다음<i class="glyphicon glyphicon-chevron-right"></i>
				</button>
			</a> <a class="tab_menu" data-toggle="tab" href="#menu1">
				<button onClick="pre_page()" class="button button_pre">
