...
public class ProjectLogic {
	...
	public BlockChain getBlockChain() {
		...
		try {
			String blockchain64 = Base64Conversion.importChain("FTBCChain",
					"C:\\Users\\kosmo_03\\Desktop\\FTBC\\test (1)\\");
	...
	public Map<String, Object> getMainProjects() {
		...
		/*
		 * DB에서 가져온 정보로 BlockChain에 있는 데이터 가져와야함. 블록체인에서 가져와야할 정보: 프로젝트 모인 금액
		 */
